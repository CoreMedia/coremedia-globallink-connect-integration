...
<!--
  On Update review and adapt the following badges:
     ...
     * (L15) GCC Used: The version of the GCC REST client used in the current release, e.g. `v3.1.9`.
...
![Current Release Version](https://img.shields.io/badge/Current-V2512.1.0--1-672779?style=for-the-badge&logo=semanticrelease)
...
![CoreMedia Content Cloud Version](https://img.shields.io/badge/CMCC-V2512.1.0-198754?style=for-the-badge&logo=semanticrelease)
