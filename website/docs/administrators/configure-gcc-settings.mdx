...
[Enabling External Definition of API Key](<../developers/coremedia-blueprint.md#enabling-external-definition-of-api-key> "Developers | CoreMedia Blueprint | Enabling External Definition of API Key")).
