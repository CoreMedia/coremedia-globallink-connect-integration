...
- [Development](#development)
  ...
  - [Introduction](#introduction)
    - [Branches](#branches)
    - [Tags](#tags)
  - [Adding GCC Adapter to the Blueprint](#adding-gcc-adapter-to-the-blueprint)
  - [Enabling the Extension](#enabling-the-extension)
  - [Adding GCC Workflow to Workflow Server Deployment](#adding-gcc-workflow-to-workflow-server-deployment)
  - [Enabling External Definition of API Key](#enabling-external-definition-of-api-key)
  - [Extension Point for Custom Properties](#extension-point-for-custom-properties)
  - [Design Details](#design-details)
    - [Translation Types](#translation-types)
    - [CMS Workflow to GCC Workflow](#cms-workflow-to-gcc-workflow)
      - [Workflow Stages](#workflow-stages)
    - [Cancellation](#cancellation)
    - [One Workflow for all Locales vs. One Workflow per Locale](#one-workflow-for-all-locales-vs-one-workflow-per-locale)
    - [Not supported: Reopening](#not-supported-reopening)
  - [Workspace Structure](#workspace-structure)
    - [workflow-server](#workflow-server)
      - [gcc-restclient-facade\*](#gcc-restclient-facade)
      - [gcc-workflow-server](#gcc-workflow-server)
    - [studio-client](#studio-client)
    - [studio-server](#studio-server)
