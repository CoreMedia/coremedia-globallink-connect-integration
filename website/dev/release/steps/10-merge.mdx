...
Thus, for a **major release** approval we merge the approval branch and
subsequently the corresponding maintenance branch _once_ to `main`,
but keep the maintenance branch for later maintenance releases.
