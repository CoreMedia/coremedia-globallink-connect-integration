...
@NullMarked
class TranslateEmptyTransunitTargetScenarioTest {
  @Nested
  class FacadeIntegrationBehavior {
    @Test
    void shouldMockXliffTranslationToEmpty(TestInfo testInfo) {
      ...
      GCExchangeFacade facade = new MockedGCExchangeFacade(MockSettings.fromMockConfig(
        Map.of(
          ...
          MockSettings.SCENARIO, TranslateEmptyTransunitTargetScenario.ID
        )
      ));
