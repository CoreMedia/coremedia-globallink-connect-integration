interface GccWorkflowLocalization_properties {
  ...
  TranslationGlobalLink_state_CancelTranslation_displayName: string,
...
const GccWorkflowLocalization_properties: GccWorkflowLocalization_properties = {
  ...
  TranslationGlobalLink_state_CancelTranslation_displayName: "Awaiting cancelation to finish",
