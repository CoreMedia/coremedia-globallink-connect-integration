...
const GccWorkflowLocalization_properties: GccWorkflowLocalization_properties = {
  ...
  TranslationGlobalLink_task_CancelTranslation_displayName: "Awaiting cancellation to finish",
  ...
  TranslationGlobalLink_state_retryCancellation_displayName: "Retry cancellation",
